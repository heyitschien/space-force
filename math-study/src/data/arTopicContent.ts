...
export const AR_TOPICS: ArTopic[] = [
  ...
  },
  {
    ...
    description: 'Master conversion factors, unit cancellation, and multi-step ASVAB conversion chains.',
    principles: [
      'A conversion factor is multiplying by 1 in a different form (ex: 1 gal / 4 qt = 1).',
      'Units must cancel like algebra. If they do not cancel, setup is wrong.',
      'Convert squared units with squared factors (1 yd² = 9 ft², not 3 ft²).',
      'For chains, convert one link at a time (tons → lb → oz, then apply rate/time).',
      'Direction matters: larger unit to smaller unit usually multiplies; reverse usually divides.',
      'Core facts: 1 ton = 2,000 lb, 1 lb = 16 oz, 1 yd = 3 ft, 1 ft = 12 in, 1 gal = 4 qt, 1 dozen = 12, 1 gross = 144, 1 mile = 5,280 ft.',
    ],
    rules: [
      'Step 1: Mark the target unit first (what should the final unit be?).',
      'Step 2: Write a factor fraction so the current unit cancels and target unit remains.',
      'Step 3: In mixed units (ft + in), convert to one unit before adding/subtracting.',
      'Step 4: For area/volume, square/cube the linear factor before converting.',
      'Step 5: Do a sanity check. Bigger destination units should produce smaller numbers.',
      'ASVAB trap: forgetting to square conversion factors for area problems.',
      'ASVAB trap: using the right factor in the wrong direction (multiply vs divide).',
    ],
    simpleExample: {
      problem: 'Convert 180 ft² to yd².',
      solution: 'Use squared factor: 180 ft² × (1 yd² / 9 ft²) = 20 yd². ft² cancels.',
    },
    practiceProblems: [
      {
        problem: 'Convert 7.5 gallons to quarts.',
        solution: '7.5 × 4 = 30 quarts.',
      },
      {
        problem: 'Convert 54 inches to feet.',
        solution: '54 ÷ 12 = 4.5 feet.',
      },
      {
        problem: 'A board is 3 ft 8 in long. What is its length in inches?',
        solution: '3 ft = 36 in. 36 + 8 = 44 inches.',
      },
      {
        problem: 'A tank holds 48 quarts. How many gallons is that?',
        solution: '48 ÷ 4 = 12 gallons.',
      },
      {
        problem: 'A room is 18 ft by 15 ft. Area in square yards?',
        solution: 'Area = 270 ft². Then 270 ÷ 9 = 30 yd².',
      },
      {
        problem: 'A truck carries 1.25 tons. How many pounds?',
        solution: '1.25 × 2,000 = 2,500 lb.',
      },
      {
        problem: 'A supply crate has 2 tons of rice. Each meal needs 20 oz. How many meals?',
        solution: '2 tons = 4,000 lb = 64,000 oz. 64,000 ÷ 20 = 3,200 meals.',
      },
    ],
  ...
  },
  {
    ...
    testQuestionIds: ['ar-p1-001', 'ar-p2-012', 'ar-p2-018', 'ar-p2-014', 'ar-p1-025'],
  },
  {
    id: 'inequalities',
